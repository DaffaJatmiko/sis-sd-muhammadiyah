...
<body>
      <header>
        ...
        <main class="container mx-auto p-8 text-center mb-8 border border-gray-300 shadow-lg rounded-md">
    <h1 class="text-5xl md:text-3xl text-[#3455EB] font-semibold mb-8 md:mb-16 border-b-2 border-[#3455EB] pb-4">Pendaftaran Peserta Didik Baru</h1>
    
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div class="flex flex-col justify-center items-center mb-8 md:mb-0">
            <img src="../image/{{$ppdb->image}}" alt="sekolah" class="w-full max-w-md mx-auto mb-4 shadow-lg rounded-md">
        </div>
        <div class="text-left md:mt-4">
            <h2 class="text-2xl md:text-xl font-semibold mb-4">{{$ppdb->title}}</h2>
            @php
                $paragraphs = explode(PHP_EOL, $ppdb->description);
            @endphp
