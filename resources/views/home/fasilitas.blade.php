    ...
    <body class="">
        ...
        <main>
              ...
              <div class=" flex items-center justify-center my-14">
                  <div class="grid grid-cols-2 gap-36 max-lg:grid-cols-1 mx-auto">
                    @foreach($facility as $data)
                        <div>
                              <div
                                  class="bg-slate-600 w-[32rem] h-72 rounded-xl flex items-center justify-center bg-cover"
                                  style="background-image: url(../image/{{$data->image}})"
                              >
                                 
                              </div>
                              <h1 class="text-center font-bold text-xl mt-5">{{$data->title}}</h1>
                        </div>  
                    @endforeach        
                  </div>
              </div>
