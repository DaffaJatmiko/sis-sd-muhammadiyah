    ...
    <header>
      ...
      <main>
            ...
            <div class="container mx-auto p-8 flex flex-col  lg:items-center lg:justify-center">
                ...
                <div class="mb-4 lg:mr-8 lg:mb-0">
                    <img src="../image/{{$achievement->image}}" alt="Crown Image" class="mx-auto lg:mx-0" />
                </div>
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-base text-gray-700 text-justify"> {{$achievement->description}} </p>
                </div>
